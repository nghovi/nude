 ...
 * @author VietNH
 */
public class OvertimeApproveHistoryAdapter extends ArrayAdapter<ApproveHistory>{
	...
	public OvertimeApproveHistoryAdapter(Context context, List<ApproveHistory> lstHistory){
