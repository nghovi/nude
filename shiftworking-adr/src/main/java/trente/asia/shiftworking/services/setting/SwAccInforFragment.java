 ...
 */
public class SwAccInforFragment extends AbstractSwFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		if(mRootView == null){
			mRootView = inflater.inflate(R.layout.fragment_swacc_infor, container, false);
		}
		return mRootView;
	}
	...
	protected void successUpload(JSONObject response, String url){
		if(WfUrlConst.WF_ACC_INFO_UPDATE_AVATAR.equals(url)){
			...
			File appFolder = new File(SwUtil.getFilesFolderPath());
