...
public class SwConst{
    ...
    public static String					SW_WORK_NOTICE_TYPE_LATE			= "LA";
    public static String					SW_WORK_NOTICE_TYPE_LEAVE_EARLY		= "LE";
    public static String					SW_WORK_NOTICE_TYPE_GO_OUT			= "GO";
    public static String					SW_WORK_NOTICE_TYPE_OTHER			= "OT";
    public static String					SW_WORK_NOTICE_TYPE_MODIFY			= "MR";
    ...
    public static WorkOfferDetailFragment.ApproveStatus YYG1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_YET,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus YYG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_YET,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus YYA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus YYA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus YAA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus YAA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus YSG1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_STOP,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus YSG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_STOP,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus YSA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus YSA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus YNG1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_NA,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus YNA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_YET, APPROVE_STATUS_NA,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus AYA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus AYG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_YET,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus AYA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus AAA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus AAA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus ASG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_STOP,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus ASA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus ASA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus ANA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_ACCEPT, APPROVE_STATUS_NA,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SYG1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_YET,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SYG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_YET,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus SYA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SYA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus SAA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SAA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus SSG1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_STOP,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SSG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_STOP,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus SSA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SSA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus SNG1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_NA,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus SNA1 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_STOP, APPROVE_STATUS_NA,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE1);
    public static WorkOfferDetailFragment.ApproveStatus NYG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_NA, APPROVE_STATUS_YET,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus NYA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_NA, APPROVE_STATUS_YET,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus NAA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_NA, APPROVE_STATUS_ACCEPT,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus NSG2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_NA, APPROVE_STATUS_STOP,
                    0, WorkOfferDetailFragment.ApproveStatus.APPROVE2);
    public static WorkOfferDetailFragment.ApproveStatus NSA2 =
            new WorkOfferDetailFragment.ApproveStatus(APPROVE_STATUS_NA, APPROVE_STATUS_STOP,
                    1, WorkOfferDetailFragment.ApproveStatus.APPROVE2);


    public static Map<WorkOfferDetailFragment.ApproveStatus, List<String>> approveStatusListMap =
            new LinkedHashMap<>();

    static {
        approveStatusListMap.put(
                YYG1,
                Arrays.asList(approveTypes.get(APPROVE_STATUS_ACCEPT),
                        approveTypes.get(APPROVE_STATUS_REVERSE),
                        approveTypes.get(APPROVE_STATUS_STOP)));
        approveStatusListMap.put(
                YYG2,
                Arrays.asList(approveTypes.get(APPROVE_STATUS_ACCEPT),
                        approveTypes.get(APPROVE_STATUS_REVERSE),
        ...
        approveStatusListMap.put(
                ...
                Arrays.asList(approveTypes.get(APPROVE_STATUS_ACCEPT),
                        approveTypes.get(APPROVE_STATUS_REVERSE),
                        approveTypes.get(APPROVE_STATUS_STOP),
                        approveTypes.get(APPROVE_STATUS_DISABLED)));
        approveStatusListMap.put(
                YYA2,
                Arrays.asList(approveTypes.get(APPROVE_STATUS_ACCEPT),
                        approveTypes.get(APPROVE_STATUS_REVERSE),
