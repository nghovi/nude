 ...
 * @author TrungND
 */
public class MsContactUsFragment extends AbstractMsgFragment implements View.OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		if(mRootView == null){
			mRootView = inflater.inflate(R.layout.fragment_ms_contact_us, container, false);
		}
		return mRootView;
	}
