...
public class DownloadFileManager{
	 ...
	 */
	public static void downloadFile(final Context ctx, final String urlMain, final File file, final OnDownloadListener pbListener){
		...
		AsyncTask<String, Void, String> execute = new AsyncTask<String, Void, String>() {
			...
			protected String doInBackground(String...params){
				...
				try{
					...
					AndroidUtil.copyStream(is, os, contentLength, pbListener);
