...
/**
 * Android ViewBadger
 * references https://github.com/jgilfelt/android-viewbadger
 */
public class ChiaseBadgeView extends TextView{
	...
	public ChiaseBadgeView(Context context){
		this(context, (AttributeSet)null, android.R.attr.textViewStyle);
	}

	public ChiaseBadgeView(Context context, AttributeSet attrs){
	 ...
	 */
	public ChiaseBadgeView(Context context, View target){
	 ...
	 */
	public ChiaseBadgeView(Context context, TabWidget target, int index){
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public ChiaseBadgeView(Context context, AttributeSet attrs, int defStyle){
		this(context, attrs, defStyle, null, 0);
	}

	public ChiaseBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex){
	...
	public void showCustom(int resId, int txtColor){
		if(CCStringUtil.isEmpty(this.getText()) || CCConst.NONE.equals(this.getText())){
			this.setVisibility(GONE);
		}else{
			applyLayoutParams();

			this.setBackgroundResource(resId);
			this.setTextColor(context.getResources().getColor(txtColor));
	...
	private void applyLayoutParams(){
		...
		if(IS_CIRCLE){
			int pixels = (int)(this.getTextSize() + extension);
			lp = new FrameLayout.LayoutParams(pixels, pixels);
		}else{
