 ...
 */
public class ChiaseProgressBar extends ProgressBar{

	private String	text		= "";
	private int		textColor	= Color.BLACK;
	private float	textSize	= 15;

	public ChiaseProgressBar(Context context){
		super(context);
	}

	public ChiaseProgressBar(Context context, AttributeSet attrs){
		super(context, attrs);
	}

	public ChiaseProgressBar(Context context, AttributeSet attrs, int defStyle){
