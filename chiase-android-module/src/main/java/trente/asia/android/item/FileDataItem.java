package trente.asia.android.item;

/**
 * Created by TrungND on 10/22/2014.
 */
public class FileDataItem implements Comparable<FileDataItem>{
	 ...
	 * FILE)
	 */
	public FileDataItem(final String fileName, final int fileType){
	...
	@Override
	public int compareTo(final FileDataItem another){
