...
public class MonthlyCalendarDayView extends LinearLayout{
	...
	private static final int			DAY_NUMBER_HEIGHT_DP	= WelfareUtil.dpToPx(18);
	...
	private void showSchedule(ScheduleModel scheduleModel){
		if(ScheduleModel.EVENT_TYPE_BIRTHDAY.equals(scheduleModel.eventType)){
			...
			int width = getWidth();
			TextView txtSchedule = MonthlyCalendarRowView.createTextView(getContext(), width, 0, scheduleModel, marginTop - DAY_NUMBER_HEIGHT_DP);
