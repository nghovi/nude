 ...
 * @author TrungND
 */
public class ClContactUsFragment extends AbstractClFragment implements View.OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		if(mRootView == null){
			mRootView = inflater.inflate(R.layout.fragment_cl_contact_us, container, false);
		}
		return mRootView;
	}
