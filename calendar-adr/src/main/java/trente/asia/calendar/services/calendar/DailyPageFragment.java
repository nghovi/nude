 ...
 * @author Vietnh
 */
public class DailyPageFragment extends SchedulesPageListViewFragment
        implements DailyScheduleClickListener, ObservableScrollViewCallbacks {
    ...
    private void buildScheduleItem(LinearLayout lnrParent, ScheduleModel
        ...
        LinearLayout item = (LinearLayout) CalendarDayListAdapter
                .buildScheduleItem(activity, layoutInflater, scheduleModel,
                        this);
