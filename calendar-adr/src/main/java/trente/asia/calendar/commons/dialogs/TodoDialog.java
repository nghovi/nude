...
public class TodoDialog extends CLOutboundDismissDialog{
	...
	public TodoDialog(Context context, final WeeklyScheduleListAdapter.OnScheduleItemClickListener listener, final NavigationHeader.OnAddBtnClickedListener onAddBtnClickedListener, List<Date> dates){
		super(context);
