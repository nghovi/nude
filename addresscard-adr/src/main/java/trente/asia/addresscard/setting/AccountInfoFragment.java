 ...
 */
public class AccountInfoFragment extends AbstractAddressCardFragment{
	...
	protected void successUpload(JSONObject response, String url){
		if(WfUrlConst.WF_ACC_INFO_UPDATE_AVATAR.equals(url)){
			...
			String appFolderName = CsUtil.getFilesFolderPath(ACConst.APP_FOLDER);
	...
	protected void eventCameraClicked(){
		CameraPhotoPreviewAccountActivity.starCameraPhotoPreviewActivity(AccountInfoFragment.this);
	}

	protected void eventGalleryClicked(){
		CameraPhotoPreviewAccountActivity.starCameraFromGalleryPhotoPreviewActivity(AccountInfoFragment.this);
	}
