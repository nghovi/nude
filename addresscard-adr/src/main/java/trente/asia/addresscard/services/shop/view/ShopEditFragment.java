...
public class ShopEditFragment extends AbstractAddressCardFragment
    implements CustomerDialogAdapter.OnCustomerDialogListener {

    private FragmentShopEditBinding binding;
    private AddressCardModel card;
    private     int                                     customerId;
    private     Dialog                                  dialog;
    private     DialogFragmentChooseCustomerBinding     viewBinding;

    public static ShopEditFragment newInstance(AddressCardModel card) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            binding = DataBindingUtil.inflate(inflater, R.layout.fragment_shop_edit, container, false);
