...
public class GLUtils{
	...
	public static int getMaxTextureSize(){
		...
		int[] attribList = new int[]{EGL_WIDTH, 100, EGL_HEIGHT, 100, EGL_NONE};
		EGL10 mEGL;
		...
		int[] attribList1 = new int[]{EGL_DEPTH_SIZE, 0, EGL_STENCIL_SIZE, 0, EGL_RED_SIZE, 8, EGL_GREEN_SIZE, 8, EGL_BLUE_SIZE, 8, EGL_ALPHA_SIZE, 8, EGL10.EGL_RENDERABLE_TYPE, 4, EGL_NONE};
