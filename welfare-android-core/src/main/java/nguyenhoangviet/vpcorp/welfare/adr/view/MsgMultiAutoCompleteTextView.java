...
public class MsgMultiAutoCompleteTextView extends MultiAutoCompleteTextView{
	...
	public MsgMultiAutoCompleteTextView(Context context, AttributeSet attributeSet){
		...
		int attrsResourceIdArray[] = {nguyenhoangviet.vpcorp.android.R.attr.viewControl, nguyenhoangviet.vpcorp.android.R.attr.mName};
		...
		mName = t.getString(list.indexOf(nguyenhoangviet.vpcorp.android.R.attr.mName));
	}
