...
public class SplashActivity extends WelfareActivity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		// getApplicationContext().getSharedPreferences(AbstractTCFragment.SHARED_PREFERENCES_NAME,
		// ActivityModel.MODE_PRIVATE).edit().putString(SENDER_ID,
		// senderId).commit();
		...
		new Handler().postDelayed(new Runnable() {
			...
			@Override
			public void run(){
				Intent i = new Intent(SplashActivity.this, MainDLActivity.class);
