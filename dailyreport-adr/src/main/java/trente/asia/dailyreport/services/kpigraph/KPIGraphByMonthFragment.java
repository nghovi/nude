 ...
 */
public class KPIGraphByMonthFragment extends AbstractDRFragment{
	...
	public int getFragmentLayoutId(){
		return R.layout.fragment_kpigraph_by_month;
	}
	...
	public void buildBodyLayout(){
		super.initHeader(null, getString(R.string.kpi_graph_bymonth), null);
	...
	private ArrayList<BarDataSet> getDataSet(){
		for(ReportMonthyGraphHolderModel model : modelList){
			if(!CCStringUtil.isEmpty(model.goal.actualSum)){
				valueX = Float.parseFloat(model.goal.actualSum);
