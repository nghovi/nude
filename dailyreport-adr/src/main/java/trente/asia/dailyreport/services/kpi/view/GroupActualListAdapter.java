...
public class GroupActualListAdapter extends ArrayAdapter<GroupKpi>{
	...
	public View getView(final int position, View convertView, ViewGroup parent){
		...
		viewHolder.txtTodayPerformance.setText(CCFormatUtil.formatAmount(groupKpi.todayActual) + " " + groupKpi.goalUnit);
		viewHolder.txtOverallPerformance.setText(CCFormatUtil.formatAmount(groupKpi.achievement) + " " + groupKpi.goalUnit);
