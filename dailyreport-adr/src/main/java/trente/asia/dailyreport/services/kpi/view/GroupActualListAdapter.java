 ...
 */
public class GroupActualListAdapter extends ArrayAdapter<ReportModel>{

	Context	context;
	int		layoutId;

	public GroupActualListAdapter(Context context, int resource, List<ReportModel> objects){
