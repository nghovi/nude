 ...
 */
public class DrAccountInfoFragment extends AbstractDRFragment{
	...
	public int getFragmentLayoutId(){
		return R.layout.dr_fragment_account_info;
	}
	...
	protected void eventCameraClicked(){
		CameraPhotoPreviewAccountActivity.starCameraPhotoPreviewActivity(DrAccountInfoFragment.this);
	}

	protected void eventGalleryClicked(){
		CameraPhotoPreviewAccountActivity.starCameraFromGalleryPhotoPreviewActivity(DrAccountInfoFragment.this);
	}
